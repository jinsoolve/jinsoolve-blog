...
const Profile = () => {
  ...
  return (
      ...
      <Flex marginTop="80px" direction="column" justifyContent="center" alignItems="center">
        ...
        >
          <Box borderRadius="50%" w="100px" transform="scale(1)">
        ...
        <Flex gap="10px" marginTop="10px" alignItems="center">
          {/* Mail */}
          <Tooltip label="jinsoolve@gmail.com">
            <a href="mailto:jinsoolve@gmail.com" target="_blank">
              <IconBox isManaged>
          ...
          <Tooltip label="Github">
            <a href="https://github.com/jinsoolve" target="_blank">
              <IconBox isManaged>
                <svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24">
                  <path
                      fill="currentColor"
          ...
          <Tooltip label="Linkedin">
            <a href="https://www.linkedin.com/in/jinsoolve/" target="_blank">
              <IconBox isManaged>
                <svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24">
                  <path
                      fill="currentColor"
          ...
          {/* Github.io */}
          <Tooltip label="Github Blog">
            <a href="https://jinsoolve.github.io" target="_blank" rel="noopener noreferrer">
              <IconBox>
                ...
                28 58 -2285 57 -1824 0 -2117 -2 -2165 -15z m2635 -778 c256 -75 442 -256 526
                -511 21 -66 23 -90 29 -440 6 -419 7 -425 88 -497 44 -40 81 -53 182 -63 115
                -12 182 -56 224 -145 20 -44 21 -58 20 -520 0 -456 -1 -478 -22 -555 -74 -273
                -272 -471 -547 -548 -80 -22 -81 -22 -965 -22 -884 0 -885 0 -965 22 -275 77
                -471 273 -548 548 l-22 80 0 1005 c0 911 2 1012 17 1078 58 246 226 445 455
                537 131 53 148 54 833 51 572 -2 641 -4 695 -20z" />
                    <path d="M1956 3570 c-112 -35 -183 -169 -157 -298 21 -103 87 -171 186 -192
                35 -7 180 -10 427 -8 334 3 377 5 413 21 179 81 195 356 26 455 l-46 27 -410
                2 c-225 1 -423 -2 -439 -7z" />
                    <path d="M1956 2290 c-113 -35 -183 -168 -157 -299 20 -100 85 -169 181 -190
                63 -15 1093 -14 1160 0 66 14 127 62 159 123 49 95 28 237 -45 309 -65 65 -31
                62 -679 64 -324 1 -603 -2 -619 -7z" />
                  </g>
                </svg>
              </IconBox>
            </a>
          ...
          {/* Velog */}
          <Tooltip label="Velog">
            <a href="https://velog.io/@jinsoolve" target="_blank">
              <IconBox>
          ...
          <Tooltip label="Tistory">
            <a href="https://jinsoolve.tistory.com" target="_blank">
              <IconBox>
                <svg
                    width="16"
                    height="16"
